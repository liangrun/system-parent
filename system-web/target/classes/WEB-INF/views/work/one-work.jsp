    ...
    <div class="row-fluid work-item nature">
      ...
      <div class="span9 work-item-image-container">
        <div class="work-item-overlay">
          <div class="inner">
            <ul>
              <li><a rel="prettyPhoto[gallery]" href="${basePath }assets/img/work3.jpg" class="gallery-btn">View
                Gallery</a></li>
              <li><a class="detail-link" href="${detailLink}">View Details</a></li>
            </ul>
          </div>
        </div>
        <img src="${basePath }assets/img/work3.jpg" alt="Beach Heat" /> </div>
    </div>
    ...
    <div class="row-fluid work-item graphics">
      ...
      <div class="span9 work-item-image-container">
        <div class="work-item-overlay">
          <div class="inner">
            <ul>
              <li><a rel="prettyPhoto[gallery]" href="${basePath }assets/img/work2.jpg" class="gallery-btn">View
                Gallery</a></li>
              <li><a class="detail-link" href="${detailLink}">View Details</a></li>
            </ul>
          </div>
        </div>
        <img src="${basePath }assets/img/work2.jpg" alt="Cables and Balls" /> </div>
    </div>
    <div class="row-fluid work-item graphics">
      <div class="span3">
        <h2> Fireworks</h2>
      ...
      <div class="span9 work-item-image-container">
        <div class="work-item-overlay">
          <div class="inner">
            <ul>
              <li><a rel="prettyPhoto[gallery]" href="${basePath }assets/img/work6.jpg" class="gallery-btn">View
                Gallery</a></li>
              <li><a class="detail-link" href="${detailLink}">View Details</a></li>
            </ul>
          </div>
        </div>
        <img src="${basePath }assets/img/work6.jpg" alt="Fireworks" /> </div>
    </div>
    <div class="row-fluid work-item nature">
      <div class="span3">
        <h2> Beauty</h2>
      ...
      <div class="span9 work-item-image-container">
        <div class="work-item-overlay">
          <div class="inner">
            <ul>
              <li><a rel="prettyPhoto[gallery]" href="${basePath }assets/img/work4.jpg" class="gallery-btn">View
                Gallery</a></li>
              <li><a class="detail-link" href="${detailLink}">View Details</a></li>
            </ul>
          </div>
        </div>
        <img src="${basePath }assets/img/work4.jpg" alt="Fireworks" /> </div>
    </div>
    <div class="row-fluid work-item nature">
      <div class="span3">
        <h2> Bridge</h2>
      ...
      <div class="span9 work-item-image-container">
        <div class="work-item-overlay">
          <div class="inner">
            <ul>
              <li><a rel="prettyPhoto[gallery]" href="${basePath }assets/img/work7.jpg" class="gallery-btn">View
                Gallery</a></li>
              <li><a class="detail-link" href="${detailLink}">View Details</a></li>
            </ul>
          </div>
        </div>
        <img src="${basePath }assets/img/work7.jpg" alt="Bridge" /> </div>
    </div>
  </div>
</div>
